...
* **Dependabot Single Pull Request for Multi-Ecosystem Updates (`GA`)** – Dependabot can now consolidate updates across multiple package ecosystems into a single pull request, reducing notification noise and making dependency management more efficient for large codebases. - [[Read the Announcement]]([[https://github.blog/changelog/2025-07-01-dependabot-single-pull-request-for-multi-ecosystem-package-updates/](https://github.blog/changelog/2025-07-01-single-pull-request-for-dependabot-multi-ecosystem-support/)]
